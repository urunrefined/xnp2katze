...
VulkanPipelineLayout::VulkanPipelineLayout(VkDevice device,
    ...
    pipelineLayoutInfo.setLayoutCount = layout ? 1 : 0;
...
VulkanPipeline::VulkanPipeline(
    VkDevice device, ShaderStage &vert, ShaderStage &frag,
    const VkPipelineVertexInputStateCreateInfo &vertexInputInfo,
    const VkRect2D &scissor, VkRenderPass renderPass,
    VkPipelineLayout pipelineLayout, VkBool32 depthEnable, VkBool32 blendEnable,
    VkPolygonMode polygonMode, VkPrimitiveTopology topology)
    : device(device) {
